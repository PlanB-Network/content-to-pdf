...
export function getSharedCss(): string {
  return `
    ...
    * { box-sizing: border-box; }
    ...
    /* ============ Table of Contents ============ */
    .toc-end { page-break-after: always; height: 0; margin: 0; padding: 0; }
    .toc-heading {
      font-size: 14pt;
      font-weight: 700;
      color: ${ORANGE};
    ...
    .final-contribute-text {
      flex: 1;
    }
    .final-contribute-text p {
      font-size: 9.5pt;
      color: #555;
      margin: 0;
      line-height: 1.5;
    }
    .final-contribute-link {
      margin-top: 4px !important;
    }
    .final-contribute-link a {
      color: ${ORANGE};
      font-size: 9pt;
    }
    .final-contribute-qr {
    ...
    @media print {
      ...
      .pdf-page .toc-end { page-break-after: auto; }
